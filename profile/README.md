![👋 We are the OSS Everything Bot team](https://user-images.githubusercontent.com/74038190/213910845-af37a709-8995-40d6-be59-724526e3c3d7.gif)

<div id="toc">
  <ul align="center" style="list-style: none">
    <summary>
      <h1>
        👋 We are the OSS Everything Bot team
      </h1>
    </summary>
  </ul>
</div>

 **<h3 align="left">🚀 Passionate fullstack developers, creating robust and scalable discord applications. Our Goal is to make a Discord application that puts you in control and does everything you need without ruining your bank account and locking you into an application</h3>**

**<h3 align="left">Rapid Fire</h3>**

- 💼 We are currently working on: **💻 Working on the web framework and api for the backend of the bot**
- 🌱 We are currently learning: **📚 All of the things**
